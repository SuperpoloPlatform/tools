...
// ==========================================================================================================
		...
		Event.Subscribe(function(e){	
			...
			var rotation = actor.pcarray['pcmesh'].GetProperty("rotation");//获得当前mesh的rotation
			actor.pcarray['pcmesh'].PerformAction('SetVisible',['visible', false]);
			if(meshname == "mesh___camera"){
				actor.pcarray['pcmesh'].PerformAction('SetMesh',['name','mesh___woman']);
				actor.pcarray['pcmesh'].PerformAction('SetVisible',['visible', true]);
			}
			else{
				actor.pcarray['pcmesh'].PerformAction('SetMesh',['name','mesh___camera']);
				actor.pcarray['pcmesh'].PerformAction('SetVisible',['visible', false]);
			}
			//CONSOLE.Write("rotation: " + rotation.x + rotation.y + rotation.z +".\n");
			actor.pcarray['pcmesh'].PerformAction('MoveMesh', ['position', [pos.x,pos.y, pos.z]],['rotation',[0,0-rotation.y,0]]);
...
// ==========================================================================================================
		...
		Event.Subscribe(function(e){
			if(player.anjian_isabled == true){
				...
				// CONSOLE.WriteLine(pos.x+" , "+pos.z);
				// CONSOLE.WriteLine("------------------------------");
				// CONSOLE.WriteLine(rot.y);
			}
		...
		}, "player.effect.rotateright.stop1");
		...
		}, "player.effect.rotateleft.stop1");
		...
		Event.Subscribe(function(e){
			...
			player.light.center = [position.x, height + 3, position.z];
		},"player.effect.light.move");
